...
- **Tema en emisión («Sonando ahora» en vivo):** consulta dinámica de los metadatos Shoutcast2 del servidor de streaming (`/stats?sid=1&json=1`) vía JSONP nativo sin problemas de CORS ni proxies externos. Despliega en tiempo real el título de la canción o tema transmitido, actualiza `MediaSession` del sistema operativo (pantalla de bloqueo móvil, notificaciones multimedia y controles físicos) y reduce la frecuencia de sondeo cuando la pestaña está inactiva para ahorrar batería.
